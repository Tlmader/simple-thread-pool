...
public interface MsgQ {
     ...
     *
     * @return the message at the head of the queue. If the queue is empty, the caller is blocked until an
     * <pre>append</pre> call (eventually) unblocks it.
     */
     ...
     *
     * @return the message at the head of the queue. If the queue is empty, the method returns <pre>null</pre>; under NO
     * circumstances does it block the calling thread.
     */
